        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="users.php" class="nav-item nav-link active"><i class="fas fa-users"></i></i>Users</a>
...
<div class="container-fluid pt-4 px-4">
            ...
            <button class="btn btn-primary   "> <a href="register.php" target="_blank" class="text-light"> Add User </a></button>
  ...
  <thead>
    <tr>
      <th class="p-2 mb-2 bg-success text-white" scope="col">Matricule</th>
      <th class="p-2 mb-2 bg-success text-white" scope="col">Full Name</th>
      <th class="p-2 mb-2 bg-success text-white" scope="col">Email</th>
      <th class="p-2 mb-2 bg-success text-white" scope="col">Phone</th>
