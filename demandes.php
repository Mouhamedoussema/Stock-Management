...
<body>
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="demandes.php" class="nav-item nav-link active"><i class="fas fa-clipboard-list"></i>Demandes</a>
        ...
        <div class="content">
            ...
            <!-- Navbar End -->
            <button class="btn btn-primary   "> <a href="art_Add.php" target="_blank" class="text-light"> Add Demande </a></button>
            <?php
  ...
  <thead>
    <tr>
      ...
      <th class="p-2 mb-2 bg-success text-white" scope="col">Username</th>
      <th class="p-2 mb-2 bg-success text-white" scope="col">SNumber</th>
      <th class="p-2 mb-2 bg-success text-white" scope="col">Date</th>
      <th class="p-2 mb-2 bg-success text-white" scope="col">Status</th>
    ...
    <?php
     ...
     if($result){
        while($row = mysqli_fetch_assoc($result)){
            ...
            <td>'.$date.'</td>
            <td>'.$status.'</td>
            <td> <a href="/pfe_project/deleteDemande.php?id='.$Id.'"> <i class="bi bi-trash-fill"></i> </a>  </td>
